...
测试地址：https://demoopenapi.jtexpress.my/webopenplatformapi/api/logistics/trace

正式地址：https://ylopenapi.jtexpress.my/webopenplatformapi/api/logistics/trace
...
|     |     |     |     |     |
| --- | --- | --- | --- | --- |
| customerCode | String(30) | Y |  | 客户编码（联系出货网点提供） |
| password | String(100) | Y |  | 请在签名工具内获取接口的password |
| txlogisticId | String(50) | N |  | 客户订单号<br>txlogisticId或者billCode 任一一个必填 |
| billCode | String(30) | N |  | 运单号，如果需要查询一票多件子单，此字段传子单号。 |
...
|     |     |     |     |     |
| --- | --- | --- | --- | --- |
| billCode | String | Y |  | 运单号 |
| details | Array | Y |  | 运单轨迹详情 |
...
"requestID":"202107300757240102310210720900DFEA"
...
| 999001030 | 数据未找到 | No order data found |
